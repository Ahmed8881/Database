...
void format_column_value_as_json(DynamicRow *row, TableDef *table_def,
                                 uint32_t col_idx);
...
char *format_row_as_json_string(DynamicRow *row, TableDef *table_def,
                                char **columns_to_select,
                                uint32_t num_columns_to_select);
char *create_json_result_string(DynamicRow **rows, int row_count,
                                TableDef *table_def, char **columns_to_select,
                                uint32_t num_columns_to_select);
...
char *json_create_result_response(DynamicRow **rows, int row_count,
                                  TableDef *table_def, char **columns_to_select,
                                  uint32_t num_columns_to_select);
...
// bool json_parse_sql_command(const char* json_str, char* sql_buffer, size_t
// buffer_size); bool json_parse_transaction_command(const char* json_str, char*
// txn_buffer, size_t buffer_size);
...
// bool json_parse_use_table_statement(cJSON* root, Statement* statement);
...
// bool json_parse_meta_command(const char* json_str, char* meta_buffer, size_t
// buffer_size);
...
void json_append_response(char *buf, size_t bufsize, const char *status,
                          const char *message);
...
void json_append_query_result(char *buf, size_t bufsize, DynamicRow **rows,
                              int row_count, TableDef *table_def,
                              char **columns_to_select,
                              uint32_t num_columns_to_select);
